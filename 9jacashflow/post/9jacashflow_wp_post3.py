...
# --- FIX: Added Tag ID Mapping ---
# This dictionary maps the category keys to their correct WordPress tag IDs.
TAG_IDS = {
    "daily_digest": 776,
    "crypto_trading": 777,
    "forex_trading": 540,
...
def post_to_wordpress(category_key, cfg):
    ...
    data = {
        ...
        # --- FIX: Changed tags from names to the correct IDs ---
        # Now it sends a list of numbers like [776, 777] instead of text.
