...
#
# UPDATED:
# - Merged "Global Economics" sources into "Forex Trading"
# - Added "Technology & AI" sources to "Online Business"
# - Fixed all indentation and stray character errors
...
# --- Tag ID Mapping (UPDATED) ---
TAG_IDS = {
    "daily_digest": 776, "crypto_trading": 777, "forex_trading": 540,
    "stock_trading": 778, "real_estate": 422, "agriculture": 544,
    "online_business": 389,
    # "global_economics" tag removed as it's merged into forex_trading
}

# --- Binance Weekly News Configuration (UPDATED) ---
BINANCE_WEEKLY_CONFIG = {
    ...
    "sources":  [
        # [NEW] Added Binance Blog and Research
        {"direct_rss": "https://www.binance.com/en/blog/rss", "google_query": "site:binance.com/en/blog", "use_google_fallback": True, "local": False},
        {"direct_rss": "https://research.binance.com/en/feed", "google_query": "site:research.binance.com", "use_google_fallback": True, "local": False},
        ...
        # [NOISE] Tends to be higher noise/sensationalism
        ...
        # [NEW] High-quality investigative crypto journalism
        {"direct_rss": "https://www.dlnews.com/rss", "google_query": "site:dlnews.com", "use_google_fallback": True, "local": False},
        {"direct_rss": "https://www.datawallet.com/rss", "google_query": "site:datawallet.com", "use_google_fallback": True, "local": False},
        {"direct_rss": "https://cryptobriefing.com/rss", "google_query": "site:cryptobriefing.com", "use_google_fallback": True, "local": False},
        {"direct_rss": "https://news.bitcoin.com/rss", "google_query": "site:news.bitcoin.com", "use_google_fallback": True, "local": False},

        # [NEW] East African crypto perspective
        {"direct_rss": "https://bitcoinke.io/feed/", "google_query": "site:bitcoinke.io", "use_google_fallback": True, "local": False},
    ]
}

# --- Category Configurations (UPDATED) ---
CATEGORIES = {
    "real_estate": {
        ...
        "sources": [
            ...
            # [NEW] Pan-African property news
            { "direct_rss": "https://africapropertynews.com/feed", "google_query": "site:africapropertynews.com", "use_google_fallback": True, "local": False },
            ...
            # [NOISE] Very consumer-facing, less investment/development
            ...
            # [NOISE] More design/urbanism than finance
            ...
            # [NOISE] Personal blog/brand, not a primary news source
            { "direct_rss": "https://kenmcelroy.com/feed/", "google_query": "site:kenmcelroy.com real estate", "use_google_fallback": True, "local": False },
            # [NEW] Real estate technology and innovation
            { "direct_rss": "https://www.propmodo.com/feed/", "google_query": "site:propmodo.com", "use_google_fallback": True, "local": False },
        ]
    },
    "agriculture": {
        ...
        "sources": [
            ...
            { "direct_rss": "httpswww.agri-pulse.com/rss", "google_query": "site:agri-pulse.com", "use_google_fallback": True, "local": False },
            ...
            # [FIXED] Corrected RSS feed from /aerospace-defense/ to /commodities/
            { "direct_rss": "https://www.reuters.com/business/commodities/rss/", "google_query": "site:reuters.com agriculture", "use_google_fallback": True, "local": False },
            # [NEW] UN Food & Agriculture Org - high-level global reports
            { "direct_rss": "httpss://www.fao.org/news/rss/en/", "google_query": "site:fao.org news agriculture", "use_google_fallback": True, "local": False },
            # [NEW] World Bank reports on Agriculture
            { "direct_rss": "https://www.worldbank.org/en/topic/agriculture/rss", "google_query": "site:worldbank.org agriculture", "use_google_fallback": True, "local": False },
        ]
    },
    "online_business": {
        "id": 308, "featured_media_ids": [26212, 26213, 26214, 26215],
        "intro": "Here’s today’s <strong>Online Business, Tech & AI</strong> roundup 💻. From startups to artificial intelligence, these are the key updates.",
        "cta": "That’s all for tech and online business today 🚀. Which AI trend or startup caught your eye? Share below!",
        "sources": [
            ...
            { "direct_rss": "https://thecondia.com/feed/", "google_query": "site:thecondia.com", "use_google_fallback": True, "local": True },
            ...
            { "direct_rss": "https://weetracker.com/feed/", "google_query": "site:weetracker.com", "use_google_fallback": True, "local": True },
            ...
            { "direct_rss": "https://hbr.org/feed", "google_query": "site:hbr.org management OR strategy", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.indiehackers.com/feed", "google_query": "site:indiehackers.com", "use_google_fallback": True, "local": False },
            # Global Tech & AI
            ...
            # [NEW] Tech & AI Sources
            { "direct_rss": "https://www.technologyreview.com/feed/", "google_query": "site:technologyreview.com ai OR tech", "use_google_fallback": True, "local": False },
            { "direct_rss": "http://feeds.arstechnica.com/arstechnica/index/", "google_query": "site:arstechnica.com tech OR ai", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://venturebeat.com/feed/", "google_query": "site:venturebeat.com ai", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.theverge.com/rss/index.xml", "google_query": "site:theverge.com tech OR ai", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://stratechery.com/feed/", "google_query": "site:stratechery.com", "use_google_fallback": True, "local": False },
            # [NOISE]
    ...
    "stock_trading": {
        ...
        "sources": [
            ...
            # [NEW] South African market perspective
            { "direct_rss": "https://www.businesslive.co.za/rss/?publication=bl", "google_query": "site:businesslive.co.za markets", "use_google_fallback": True, "local": False },
            ...
            # [NOISE] MarketWatch is often very clickbait-heavy
            ...
            # [NOISE] Yahoo Finance is mostly aggregated content and high-noise
            ...
            # [NEW] Excellent for educational content and market analysis
            { "direct_rss": "https://www.investopedia.com/rss/articles", "google_query": "site:investopedia.com markets", "use_google_fallback": True, "local": False },
            # [NEW] Good for long-form investment analysis
            { "direct_rss": "https://seekingalpha.com/feed.xml", "google_query": "site:seekingalpha.com market news", "use_google_fallback": True, "local": False },
        ]
    },
    "forex_trading": {
        "id": 539, "featured_media_ids": [24978, 25005, 24942],
        "intro": "Here’s your <strong>Forex & Global Economics</strong> daily digest 📊. Stay ahead of FX markets, macro trends, and policy news.",
        "cta": "That’s a wrap on forex and economics today 🌍. Which currency pair or macro trend are you watching?",
        "sources": [
            # Forex Sources
            ...
            { "direct_rss": "https://www.cbn.gov.ng/RSS/LatestNews.xml", "google_query": "site:cbn.gov.ng press releases", "use_google_fallback": True, "local": True },
            { "direct_rss": "https://africa.businessinsider.com/rss", "google_query": "site:africa.businessinsider.com currency", "use_google_fallback": True, "local": True },
           ...
           #{ "direct_rss": "https://www.bloomberg.com/professional/feed/insights/topics/foreign-exchange/", "google_query": "site:bloomberg.com forex", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.ft.com/currencies?format=rss", "google_query": "site:ft.com currencies", "use_google_fallback": True, "local": False },
            # [MERGED] Global Economics Sources
            { "direct_rss": "https://nairametrics.com/category/economy/feed/", "google_query": "site:nairametrics.com economy", "use_google_fallback": True, "local": True },
            { "direct_rss": "https://businessday.ng/category/economy/feed/", "google_query": "site:businessday.ng economy", "use_google_fallback": True, "local": True },
            { "direct_rss": "https://www.stears.co/feed/", "google_query": "site:stears.co economy", "use_google_fallback": True, "local": True },
            { "direct_rss": "https://www.businesslive.co.za/rss/?publication=bd", "google_query": "site:businesslive.co.za economy", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.economist.com/finance-and-economics/rss.xml", "google_query": "site:economist.com finance", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.ft.com/world?format=rss", "google_query": "site:ft.com world economy", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://feeds.bloomberg.com/opinion/news.rss", "google_query": "site:bloomberg.com/opinion", "use_google_fallback": True, "local": False },
            { "direct_rss": "http://feeds.reuters.com/reuters/businessNews", "google_query": "site:reuters.com business", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.aljazeera.com/economy/feed/", "google_query": "site:aljazeera.com economy", "use_google_fallback": True, "local": False },
            { "direct_rss": "http://newsrss.bbc.co.uk/rss/newsonline_uk_edition/business/rss.xml", "google_query": "site:bbc.co.uk/news/business", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.worldbank.org/en/news/rss", "google_query": "site:worldbank.org news", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.imf.org/en/News/rss", "google_query": "site:imf.org news", "use_google_fallback": True, "local": False },
            { "direct_rss": "https://www.cfr.org/rss/publication/publication", "google_query": "site:cfr.org global economy", "use_google_fallback": True, "local": False },
        ]
    },
    "crypto_trading": {
...
def post_to_wordpress(category_key, cfg):
    ...
    # Ensure the correct tag ID is fetched, defaulting to None if not found
    tag_id = TAG_IDS.get(category_key)
    post_tags = [TAG_IDS["daily_digest"]]
    if tag_id:
...
def run_binance_weekly_roundup_google_only():
    """
    Job to fetch and send the weekly Binance news to Telegram using a single Google query.
    """
