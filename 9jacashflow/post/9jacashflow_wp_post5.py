...
CATEGORIES = {
    "stock_trading": {
        ...
        "sources": [
            ...
            {"url": "https://www.cnbc.com/id/100003114/device/rss/rss.html", "local": False},
    ...
    "crypto_trading": {
        ...
        "sources": [
            ...
            {"url": "https://bitcoinist.com/feed/", "local": False},
            {"url": "https://www.newsbtc.com/feed/", "local": False},
    ...
    "online_business": {
        ...
        "sources": [
            ...
            {"url": "https://www.businessinsider.com/rss", "local": False},
...
def fetch_top_stories(sources, max_items=MAX_ITEMS):
    """
    Fetches stories ensuring 1–2 per source, then fills up the rest.
    """
    stories = []
    used_links = set()
    ...
    # Pass 1: Guarantee 1–2 per source
