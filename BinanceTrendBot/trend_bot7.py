...
async def send_report():
    ...
    for group_id in TELEGRAM_GROUP_IDS:
        ...
        # FIX: Prevent pool exhaustion by adding a short delay between sending to different chats
...
if __name__ == "__main__":
    ...
    # Scheduler
    schedule.every().day.at("09:07", YOUR_TIMEZONE).do(run_scanner_job)
    schedule.every().day.at("14:07", YOUR_TIMEZONE).do(run_scanner_job)
    schedule.every().day.at("00:07", YOUR_TIMEZONE).do(run_scanner_job)
